    ...
    <ul class="sidebar-menu" data-widget="tree">
      ...
      <li class="treeview">
        ...
        <ul class="treeview-menu">
            ...
            <li><a href="{{route('brand.index')}}"><i class="fa fa-circle-o"></i>لیست شرکت‌های سازنده</a></li>
            <li><a href="{{route('brand.create')}}"><i class="fa fa-circle-o"></i>افزودن شرکت سازنده جدید</a></li>
        </ul>
