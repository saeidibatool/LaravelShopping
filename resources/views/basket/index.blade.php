            ...
            <table class="table table-bordered">
              ...
              <tbody>
                ...
                <?php foreach ($baskets as $basket): ?>
                  <?php $discount += $basket->count * $basket->product->discount * $basket->product->price / 100; ?>
                  <tr>
                    <td class="text-center"><a href="product.html"><img src="/{{$basket->product->image}}" alt="{{$basket->product->name}}" title="{{$basket->product->name}}" class="img-thumbnail" style="width:100px; height:100px"/></a></td>
                    ...
                    <td class="text-right">{{$basket->price * $basket->count}}</td>
                  </tr>
                <?php endforeach; ?>
          ...
          <div class="col-sm-4 col-sm-offset-8">
            <table class="table table-bordered">
              ...
              <tr>
                ...
                <td class="text-right">{{$sum - $discount}} تومان</td>
              </tr>
            </table>
          </div>
        </div>
